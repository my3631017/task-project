...
public class ShortMessageUtil {
    @Value("${shortMessage.product}")
    private String product;
    @Value("${shortMessage.domain}")
    ...
    @Value("${shortMessage.templateCode}")
    private String templateCode;

    public String sendShortMessage(String phoneNumber) throws ClientException {
        //设置超时时间-可自行调整
